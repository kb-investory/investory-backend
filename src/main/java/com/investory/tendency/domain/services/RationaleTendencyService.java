...
public class RationaleTendencyService {
    ...
    private final RationaleLabelStatsRepository rationaleLabelStatsRepository;

    public RationaleTendencyService(RationaleLabelStatsRepository rationaleLabelStatsRepository) {
        this.rationaleLabelStatsRepository = rationaleLabelStatsRepository;
    }
    ...
    public RationaleTendencyResult analyze(AnalyzeRationaleTendencyQuery query) {
        ...
        Map<RationaleLabelType, Long> counts = rationaleLabelStatsRepository
